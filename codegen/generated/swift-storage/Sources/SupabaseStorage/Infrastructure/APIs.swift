...
internal class SupabaseStorageAPIConfiguration: @unchecked Sendable {
    ...
    internal static let shared = SupabaseStorageAPIConfiguration()
}
...
internal class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    internal let apiConfiguration: SupabaseStorageAPIConfiguration
    ...
    required internal init(
        ...
        apiConfiguration: SupabaseStorageAPIConfiguration = SupabaseStorageAPIConfiguration.shared
    ) {
        self.method = method
